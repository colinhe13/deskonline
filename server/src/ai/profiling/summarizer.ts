...
1. 只输出 JSON：{"summary": "..."}
2. summary 不超过 150 个汉字，且必须是完整句子（宁可少写也不要被截断），只描述风格倾向（紧/松、凶/被动、诈唬频率、抓诈唬倾向、位置意识、价值下注尺度等）；输入中若含亮牌/摊牌牌型，请结合行动推断其诈唬与价值下注倾向（如多次亮出弱牌却赢下底池说明诈唬成功率高）；若 foldToCbet（面对翻牌持续下注弃牌率）明显偏高或偏低，需提及其对持续施压的敏感度
